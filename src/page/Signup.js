...
function Signup() {
    ...
    useEffect(()=>
        ...
        },[ho,ten,taikhoan,matkhau,email,nhaclai,sdt])
    const handleDangky=()=>
        {
            ...
            <div className="khung-dang-tren pb-5">
                ...
                <div className="khung-dang-ky py-5">
                    ...
                    <div className="row ">
                        ...
                        <div className="col-12">
                         <Link to={`${kiemtra?"/dangnhap":"/dangky"}`}>   <button className="btn btn-secondary btn-block"
                           onClick={handleDangky}>Đăng Ký</button></Link>
                        </div>
